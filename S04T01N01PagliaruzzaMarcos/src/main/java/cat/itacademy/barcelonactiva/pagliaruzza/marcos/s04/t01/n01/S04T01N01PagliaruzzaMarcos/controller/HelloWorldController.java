package cat.itacademy.barcelonactiva.pagliaruzza.marcos.s04.t01.n01.S04T01N01PagliaruzzaMarcos.controller;
...
public class HelloWorldController {
    ...
    public String greets2(@PathVariable Optional<String> name) {
        return "Hello, " + name.orElse("UNKNOWN") + ". You are running a Maven project.";
    }
